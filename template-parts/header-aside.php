...
use function Little_Buddy\active_pmpro;
 ...
 * Registration URL
 *
 * Gets the Paid Membership Pro levels page URL
 * if the plugin is active. Otherwise gets the
 * default registration URL.
 */
if ( active_pmpro() ) {
	global $pmpro_pages;
	$registration_url = get_permalink( $pmpro_pages['levels'] );
} else {
		...
		<?php else : ?>
			...
			<div class="bb-header-buttons">
				...
				<?php if ( get_option( 'users_can_register' ) ) : ?>
					<a href="<?php echo esc_url( $registration_url ); ?>" class="button small singup"><?php esc_html_e( 'Sign up', 'buddyboss-theme' ); ?></a>
				<?php endif; ?>
			</div>
